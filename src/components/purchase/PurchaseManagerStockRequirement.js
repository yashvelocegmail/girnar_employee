...
function PurchaseManagerStockRequirement() {
                    ...
                    <form>
                        <div className="card-body">
                            ...
                            <div className="form-group">
                                ...
                                <input defaultValue={singleStockRequest.no_of_sheets} type="text" name="no_of_sheets" className="form-control" readOnly/>
                            </div>
                        </div>
                    </form>
                </Modal.Body>
                ...
                <Modal.Body>
                    <form onSubmit={onModalFormSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <div className="form-group">
                                <label>PO</label>
                                <input onChange={onModalInputChange} defaultValue={modalStockRequest.po} name="po" type="text" className="form-control" readOnly />
                            </div>
                            <div className="form-group">
                                <label>Material Type</label>
                                <select onChange={onModalInputChange} defaultValue={modalStockRequest.material_type} className='form-control' name="material_type"readOnly>
                                    {materialTypeOption === undefined ? [] : materialTypeOption.data.map((type) => (
                                        <option disabled key={type.id} value={type.id}>{type.material_type}</option>
                                    ))}
                                </select>
                            </div>
                            <div className="form-group">
                                <label >Material Thickness</label>
                                <select onChange={onModalInputChange} defaultValue={modalStockRequest.material_thickness} className='form-control' name="material_thickness"readOnly>
                                    {materialThicknessOption === undefined ? [] : materialThicknessOption.data.map((thickness) => (
                                        <option disabled key={thickness.id} value={thickness.id}>{thickness.material_thickness}</option>
                                    ))}
                                </select>
                            </div>
                            <div className="form-group">
                                <label >Material Grade</label>
                                <select onChange={onModalInputChange} defaultValue={modalStockRequest.material_grade} className='form-control' name="material_grade"readOnly>
                                    {materialGradeOption === undefined ? [] : materialGradeOption.data.map((grade) => (
                                        <option disabled key={grade.id} value={grade.id}>{grade.material_grade}</option>
                                    ))}
                                </select>
                            </div>
                            <div className="form-group">
                                <label >No Of Sheets</label>
                                <input onChange={onModalInputChange} defaultValue={modalStockRequest.no_of_sheets} type="text" name="no_of_sheets" className="form-control"readOnly />
                            </div>
                            <div className="form-group">
                                <label >No Of Sheets</label>
                                <input onChange={onModalInputChange} defaultValue={modalStockRequest.no_of_sheets} type="text" name="no_of_sheets" className="form-control" readOnly/>
                            ...
                            <div className="form-group">
                                <label >Status</label>
                                {/* <input onChange={onModalInputChange} defaultValue={modalStockRequest.status} type="text" name="status" className="form-control" /> */}
                                <select onChange={onModalInputChange} name="status" className="form-control">
...
export default PurchaseManagerStockRequirement
