...
function TransporterProduction() {
    ...
    const onEditTransporterFileChange = (e) => {
        setEditWorkOrder({ ...editWorkOrder, transporter_file: e.target.files[0] })
    }
    const onEditTransporterCommentChange = (e) => {
        setEditWorkOrder({ ...editWorkOrder, transporter_comment: e.target.value })
    }
    const onModalFormSubmit = (e) => {
        ...
        axios.post(api_url + "update_work_order.php", modalFormData, config)
            .then(() => {
                axios.post(api_url + "read_work_order_by_transporter.php", { transporter: localStorage.getItem('employee_id') })
                    .then((res) => {
                                ...
                                <div class="card-body">
                                    <div class="card card-primary card-outline">
                                        <div class="card-header">
                                            ...
                                            <select onChange={onEditDesignerHeadChange} defaultValue={editWorkOrder.designer_head} name="designer_head" className='form-control' readOnly>
                                ...
                                <div class="card-body">
                                    <div class="card card-primary card-outline">
                                        <div class="card-header">
                                            ...
                                            <select onChange={onEditDesignerChange} defaultValue={editWorkOrder.designer} className='form-control' readOnly>
                                                <option>Select</option>
                                    ...
                                    <div class="card card-primary card-outline">
                                        <div class="card-header">
                                            ...
                                            {editFormValues3.map((element, index) => (
                                                <div className="form-group" key={index}>
                                                    <label>Description</label>
                                                    <input className="form-control" type="text" name="description3" value={element.description3 || ""} onChange={e => editHandleChange3(index, e)} readOnly />
                                                    <label>Status</label>
                                ...
                                <div class="card-body">
                                    <div class="card card-primary card-outline">
                                        <div class="card-header">
                                            ...
                                            <input onChange={onEditTransporterFileChange} type="file" className='form-control' name="transporter_file" />
                                            <label>Download File</label><br />
                                            ...
                                            {/* <label >File Uploaded</label>
                                                    <img src="https://picsum.photos/200/35" alt="File" /> */}
                                            <label>Comment</label>
                                            <input type="text" name="transporter_comment" className='form-control' defaultValue={editWorkOrder.transporter_comment} onChange={onEditTransporterCommentChange} />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default TransporterProduction
